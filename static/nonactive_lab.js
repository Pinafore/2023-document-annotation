...
intro.setOptions({
    steps: [
        ...
        {
            element: '#topic11',
            intro: 'In this block, you will find word clusters associated with the passage, ranked by relevance. These word clusters can also serve as potential label ideas for the passage'
        },
        {
            element: '#buttons',
