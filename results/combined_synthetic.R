...
# Create the plots
p1_1 <- plot_with_markers(congressional_results, "numDocsLabeled", "purity", "group", "Purity", hide_x=TRUE)
p2_1 <- plot_with_markers(congressional_results, "numDocsLabeled", "randIndex", "group", "ARI", hide_x=TRUE)
p3_1 <- plot_with_markers(congressional_results, "numDocsLabeled", "NMI", "group", "ANMI")
