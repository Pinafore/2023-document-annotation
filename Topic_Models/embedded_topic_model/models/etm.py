...
class ETM(object):
    ...
    def _perplexity(self, test_data) -> float:
        ...
        with torch.no_grad():
            ...
            if self.debug_mode:
                # self.test_perplexity.append(ppl_dc)
    ...
    def fit(self, train_data, test_data=None):
        ...
        for epoch in range(1, self.epochs):
            ...
            if self.eval_perplexity:
                ...
                # training_val_ppl = self._perplexity(train_data)
                val_ppl = self._perplexity(
                    test_data)
                # self.val_perplexity.append(training_val_ppl)
                self.test_perplexity.append(val_ppl)
