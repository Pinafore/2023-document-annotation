...
class NAITM():
    def __init__(self, documents, doc_prob, doc_topic_prob, df, running_type, text_vectorizer, train_len, mode, test_dataset_frame):
        ...
        self.general_labels = df['general_labels'].tolist()
    ...
    def eval_classifier(self):
        ...
        print('evaluating...')
        print(len(local_training_preds))
        print(self.total_length)
        print(len(self.test_sub_labels))
        print(len(local_training_preds[self.train_length:self.total_length]))
        ...
        # print('testing length is ,', len(self.test_general_labels))
        # print('preds length is, ', len(local_training_preds[self.train_length:self.total_length]))
