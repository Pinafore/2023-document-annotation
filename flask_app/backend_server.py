    ...
    def __init__(self, mode, user_id):
        ...
        if mode != 0:
            if mode == 1 or mode == 2:
                ...
                self.alto = Active_Learning(self.raw_texts, copy.deepcopy(self.document_probas), self.doc_topic_probas, self.df, inference_alg, self.vectorizer_idf, training_length, 1, self.test_df, None)
            elif mode == 3:
